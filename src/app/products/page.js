  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex items-end justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold" style={{ color: "#1C2E6B" }}>
            All Products
          </h1>
          <p className="text-sm text-gray-500 mt-1">
            {products.length} replacement remotes available across TV, AC, set-top box, speaker, streaming, projector, and universal categories.
          </p>
        </div>
        <a
