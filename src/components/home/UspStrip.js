...
export default function UspStrip() {
  return (
    <section className="hidden lg:block py-6" aria-label="Store benefits">
      <div className="border-y border-gray-100 bg-white px-6 py-8">
        <div className="grid grid-cols-4 divide-x divide-gray-100">
          {USP_ITEMS.map((item) => (
            <div key={item.title} className="flex flex-col items-center justify-center text-center px-6 first:pl-0 last:pr-0">
